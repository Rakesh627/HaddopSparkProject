...
public class ConvexHull {
	...
	public static void main(String[] args) throws IOException {
		System.out.println(ConvexHull.Convex(args[0],args[1]));
				
	}
	
	public static Boolean Convex(String input, String output) {
...
//                    }
    ...
    dispConvex.foreach(new VoidFunction<String>(){
	...
	boolean flag = true;
	try{
		dispConvex.saveAsTextFile(output.trim());
	}
	catch(Exception e)
	{
		flag = false;
